<div class="cart-order__item">
		<div class="cart-order__item-title"><?php echo $entry_country; ?> *</div>
		<select class="cart-order__item-input" name="country_id" id="input-country">
...
<div class="cart-order__item">
	<div class="cart-order__item-title"><?php echo $entry_postcode; ?></div>
	<input class="cart-order__item-input" name="postcode" id="input-postcode" type="text">
	<span class="error"></span>
</div>
